...
import Principal "mo:base/Principal"; // dfinity nin Internet Comp ağında kullanıcısı, idler benzersiz
import ICRaw "mo:base/ExperimentalInternetComputer"; // bir canister çağırmak için, main nete girmiyoruz, test nete giriyoruz deneysel bir canister çağırıyoruz
